...
model = tf.keras.models.load_model(dir_path + '/model.h5')
...
with open(dir_path +'/out/classification_report.txt', 'w') as f:
...
plt.savefig(dir_path + '/out/confusion_matrix.png')
plt.close()